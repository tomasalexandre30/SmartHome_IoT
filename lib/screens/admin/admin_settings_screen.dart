        ...
        children: [
          ...
          Container(
            ...
            child: const Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                Icon(Icons.shield_rounded, color: AppTheme.accent, size: 14),
                SizedBox(width: 6),
                Text('Administrador',
                    style: TextStyle(
                        color: AppTheme.accent,
          ...
          const SizedBox(height: 12),
          _InfoRow(icon: Icons.shield_rounded, label: 'Papel no sistema',
              value: 'Administrador', valueColor: AppTheme.accent),
          const SizedBox(height: 12),
          _InfoRow(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      const Expanded(child: Text('Intensidade de luz',
                          style: TextStyle(color: AppTheme.textSecondary, fontSize: 13))),
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      const Expanded(child: Text('Temperatura preferida',
                          style: TextStyle(color: AppTheme.textSecondary, fontSize: 13))),
                      Text('${prefs.temperatureTarget.toStringAsFixed(0)}°C',
                          style: const TextStyle(
                              color: AppTheme.error, fontSize: 13, fontWeight: FontWeight.w600)),
                    ],
                  ),
                  Slider(
                  ...
                  Row(
                    children: [
                      ...
                      const SizedBox(width: 8),
                      const Expanded(child: Text('Não incomodar',
                          style: TextStyle(color: AppTheme.textSecondary, fontSize: 13))),
                      Switch(
                        value: prefs.doNotDisturb,
                        onChanged: (v) =>
                            ss.updatePreferences(prefs.copyWith(doNotDisturb: v)),
                      ),
                    ],
                  ),
                ],
...
class _ActionRow extends StatelessWidget {
  ...
  const _ActionRow({required this.icon, required this.label,
    this.subtitle, required this.color, required this.onTap});
  @override
